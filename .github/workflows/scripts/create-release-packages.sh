...
#     AGENTS  : space or comma separated subset of: claude gemini copilot cursor-agent qwen opencode windsurf codex kilocode auggie roo codebuddy qodercli amp shai tabnine kiro-cli agy bob droid vibe kimi generic (default: all)
